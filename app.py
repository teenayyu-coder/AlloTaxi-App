...
# -------------------------------------------------------
# 🔵 FONCTION POUR LE RERUN SÉCURISÉ
# -------------------------------------------------------
def st_rerun():
...
INITIAL_DATA = {
    "Users": [
        {"Category":"Admin","First Name":"admin","Phone":"000000000","Password":hashlib.sha256("adminpass".encode()).hexdigest(),
         "Vehicle Brand":"","Vehicle Type":"","Engine Displacement":"","Is Online":False},
        {"Category":"Client","First Name":"testclient","Phone":"032111111","Password":hashlib.sha256("password".encode()).hexdigest(),
         "Vehicle Brand":"","Vehicle Type":"","Engine Displacement":"","Is Online":False},
        {"Category":"Driver","First Name":"testdriver","Phone":"034222222","Password":hashlib.sha256("password".encode()).hexdigest(),
...
def save_data(data, initial_create=False):
    ...
    if not github_credentials_available():
        st.info("Sauvegarde locale seulement.")
        return
    api_url = get_github_api_url()
...
def update_user_online_status(user_name, is_online):
    ...
    if not user_row.empty:
        update_row_field("Users", user_row.index[0], "Is Online", is_online)
...
# =======================================================
# PAGES CLIENT, DRIVER, ADMIN (identiques aux codes précédents)
# Pour gagner de la place, je peux te fournir ces pages complètes
# si tu veux que je mette tout dans un seul fichier avec tout fonctionnel.
# =======================================================
